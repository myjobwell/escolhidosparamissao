...
import '../../services/sincronizacao/matriculas_sincronizacao.dart'; // atualizado
...
class _MatriculaAlunoScreenState extends State<MatriculaAlunoScreen> {
  ...
  void _confirmarMatricula() async {
    ...
    // 2. Sincroniza com Firebase (usando nova classe com sincronização bidirecional)
    await MatriculasSincronizacao.sincronizar(idAluno);
